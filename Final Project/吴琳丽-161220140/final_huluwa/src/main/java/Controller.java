...
import company.BattleField.BattleField;

import company.Creature.*;
import company.Formation.*;
...
public class Controller {
   ...
   /* Image image1;
    ...
    Image image7;
    Image imagelouluo;
    Image imagexiezijing;
    Image imageyeye;
    Image imageshejing;
    Image imagedead;
    Image imagehuluwin;
    Image imageyaoguaiwin;*/
   String a="";
    Image image1= new Image(a+"1.jpg");
    Image image2= new Image(a+"2.jpg");
    Image image3= new Image(a+"3.jpg");
    Image image4= new Image(a+"4.jpg");
    Image image5= new Image(a+"5.jpg");
    Image image6= new Image(a+"6.jpg");
    Image image7= new Image(a+"7.jpg");
    Image imagelouluo= new Image(a+"louluo.png");
    Image imagexiezijing= new Image(a+"xiezijing.png");
    Image imageyeye= new Image(a+"yeye.png");
    Image imageshejing= new Image(a+"shejing.png");
    Image imagedead= new Image(a+"dead.jpg");
    Image imagehuluwin= new Image(a+"huluwin.jpg");
    Image imageyaoguaiwin= new Image(a+"yaoguaiwin.jpg");
